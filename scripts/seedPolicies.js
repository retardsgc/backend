...
const policiesData = {
  ...
  'terms-conditions': {
    ...
    contactInfo: {
      email: 'legal@nutrinuts.com',
      companyName: 'NutriNuts Store'
    }
  },
  'privacy-policy': {
    ...
    contactInfo: {
      email: 'privacy@nutrinuts.com',
      address: '123 Healthy Snack Blvd, Nutri Suite 400, NY 10006'
    }
  }
};
...
async function seedPolicies() {
  try {
    // Connect to MongoDB using DATABASE variable
    const mongoUri = process.env.DATABASE || process.env.MONGODB_URI || process.env.MONGO_URI;
    if (!mongoUri) {
